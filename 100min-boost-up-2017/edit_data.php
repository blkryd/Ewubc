...
if(isset($_POST['btn-update']))
{
	...
	$sql_query = "UPDATE users SET first_name='$first_name',uni_id='$uni_id',number='$number',email='$email' WHERE user_id=".$_GET['edit_id'];
	// sql query for update data into database
...
<div id="header">
	<div id="content">
    <label>100 Minutes Boost Up Participants Registration</label>
    </div>
</div>
