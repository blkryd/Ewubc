...
if(isset($_POST['btn-save']))
{
	...
	$sql_query = "INSERT INTO users(first_name,uni_id,email, number) VALUES('$first_name','$uni_id','$email','$number')";
	// sql query for inserting data into database
...
<div id="header">
    ...
    <label>100 Minutes Boost Up Participants Registration</a></label>
    </div>
</div>
