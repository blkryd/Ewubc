...
if(isset($_POST['btn-save']))
{
    ...
    $sql_query = "INSERT INTO tbl_participants(p_name,uni_id, phone,team_email,team_name,update_time) VALUES('$first_name','$uni_id','$phone','$email','$team_name','$time')";
...
<center>
    ...
    <div id="body"  class="container">
        <div id="content">
            <form method="post" onsubmit="return confirm('Are you sure you want to submit the form?');" action="add_data.php" style="margin-top: -14px">
                <table align="center">
                    <tr>
