...
if(isset($_POST['btn-save']))
{
    ...
    $sql_query = "INSERT INTO tbl_participants(p_name,uni_id, phone,ref,company,status,update_time) VALUES('$first_name','$uni_id','$phone','$ref','$company','$status','$time')";
...
<center>
    ...
    <div id="body"  class="container">
        <div id="content">
            <form method="post" onsubmit="return confirm('Are you sure you want to submit the form?');" action="add_data_a.php" style="margin-top: -42px">
                <table align="center">
                    <tr>
